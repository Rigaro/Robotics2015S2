...
%colours
grey = [0.7 0.7 0.7];
brown = [0.83 0.71 0.56]; 
grass_green = [0.28 0.71 0.28];

fill3(top_face(:, 1), top_face(:, 2), top_face(:, 3), brown)
fill3(east_face(:, 1), east_face(:, 2), east_face(:, 3), brown)
fill3(west_face(:, 1), west_face(:, 2), west_face(:, 3), brown)
fill3(north_face(:, 1), north_face(:, 2), north_face(:, 3), brown)
fill3(south_face(:, 1), south_face(:, 2), south_face(:, 3), brown)
